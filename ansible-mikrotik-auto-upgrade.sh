...
ansible routers_tutti -m raw -a '/system package update set channel=bugfix;local version value=[/system package update check-for-updates];:put "$version is available to download";quit' -c paramiko -u admin -k
